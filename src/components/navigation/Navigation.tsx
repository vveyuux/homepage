                ...
                {navMenu.map((nav, index) => (
                    <li key={index}>
                        <a className="group flex items-center py-3 active transition-all duration-150 ease-in-out" href={nav.href}>
                            <span className="nav-indicator mr-4 h-px w-8 bg-primary dark:bg-textDark/75 transition-all group-hover:w-16 dark:group-hover:bg-textDark group-hover:bg-secondary dark:group-hover:bg-textDark group-focus-visible:w-16 group-focus-visible:bg-accent dark:group-focus-visible:bg-accentDark motion-reduce:transition-none"></span>
