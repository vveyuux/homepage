...
const About: React.FC = () => {
    return (
        <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
            <div className="sticky top-0 z-30 -mx-6 mb-4 w-screen bg-primary/75 dark:bg-primaryDark/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
                <h2 className="text-sm font-bold uppercase tracking-widest text-white lg:sr-only">About</h2>
            </div>
            <div className="text-text dark:text-slate-300">
                <p className="mb-4">
                ...
                <p className="mb-4">
                    ...
                    <a href="https://scbtechx.io/th/home/" target="_blank">
                        <span className="font-bold dark:text-textDark hover:text-primary dark:hover:text-primaryDark transition-colors duration-200 ease-in-out">SCB TechX</span>
                    </a>
                    ...
                    <span className="font-bold dark:text-textDark hover:text-primary dark:hover:text-primaryDark transition-colors duration-200 ease-in-out">Clocking Web App</span>, a system that
                    ...
                    the <span className="font-bold dark:text-textDark hover:text-primary dark:hover:text-primaryDark transition-colors duration-200 ease-in-out">Overtime Web App</span> which is a
